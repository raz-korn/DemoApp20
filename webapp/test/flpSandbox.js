		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ns20dempapp20-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ns20dempapp20-display": {
								"semanticObject": "ns20dempapp20",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns20.dempapp20",
									"url": sap.ui.require.toUrl("ns20/dempapp20")
								}
							}
						}
					}
